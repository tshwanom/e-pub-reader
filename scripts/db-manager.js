...
<head>
    ...
    <style>
        ...
        button.danger:hover { background: #fee2e2; border-color: #fecaca; }
...
const server = http.createServer((req, res) => {
    ...
    if (req.url.startsWith('/run/')) {
        ...
        else if (cmd === 'studio') args = ['prisma', 'studio']; // Note: Studio blocks, might need handling
        ...
        req.on('close', () => {
            if (cmd !== 'studio') child.kill(); // Don't kill studio if browser disconnects temporarily
        });
