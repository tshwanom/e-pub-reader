...
export default function CurrencyPicker({
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {isOpen ? (
        <div className="absolute left-0 right-0 top-full z-20 mt-2 overflow-hidden rounded-2xl border border-landing-border bg-white/95 shadow-xl backdrop-blur-xl">
          <div className="border-b border-landing-border/80 p-3">
